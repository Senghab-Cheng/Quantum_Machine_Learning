...
project_rooth = Path(__file__).resolve().parent
...
if __name__ == "__main__":
    print(f"Project root: {project_rooth}")
    print(f"Raw data path: {Raw_data_path}")
    print(f"Feature columns: {feature_columns}")
    print(f"Logistic regression params: {LOGISTIC_REGRESSION_PARAMS}")
    print(f"Random forest grid: {Random_forest_grid}")